...
public class Alarm {
    ...
    public Alarm() {
        ...
        // my code begin
        waitingList = new List<WaitingThread>();
        // my code end
    ...
    public void timerInterrupt() {
        ...
        // my code begin
        int i = waitingList.size() - 1;
        WaitingThread wThread;
        while (i >= 0)
        {
            wThread = waitingList.get(i);
            if (wThread.wakeTime <= currTime )
            {
    ...
    public void waitUntil(long x) {
        ...
        // my code begin
        WaitingThread wThread = new WaitingThread(KThread.currentThread(), wakeTime);
        waitingList.add(wThread);
		KThread.sleep();
        // my code end
    }
    ...
    private class WaitingThread
    {
        ...
        public WaitingThread(KThread _thread, long _wakeTime)
        {
            thread = _thread;
            wakeTime = _wakeTime;
        }
    ...
    private List<WaitingThread> waitingList;
    // my code end
